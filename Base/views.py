...
from .forms import ActualizacionInstrumento, FormularioCambioPassword, FormularioEdicion, FormularioNuevoInstrumento, \
    FormularioRegistroUsuario, FormularioComentario
