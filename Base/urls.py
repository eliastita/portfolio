...
from .views import GuitarraDelete, InstrumentoCreacion, GuitarraDetalle, AmplificadorLista, TecladoLista, BateriaLista, \
    BajoLista, GuitarraLista, PedalLista, OtroLista, BajoDetalle, PedalDetalle, AmplificadorDetalle, TecladoDetalle, \
    BateriaDetalle, OtroDetalle, GuitarraUpdate, BajoUpdate, PedalUpdate, AmplificadorUpdate, TecladoUpdate, \
    BateriaUpdate, OtroUpdate, BajoDelete, PedalDelete, AmplificadorDelete, TecladoDelete, BateriaDelete, OtroDelete, \
    LoginPagina, RegistroPagina, UsuarioEdicion, CambioPassword, HomeView, ComentarioPagina
